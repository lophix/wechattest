...
public class XmlBean {
    ...
    private String dtail;  //商品详情，非必填
    private String attach;  //附加数据，非必填
    private String out_trade_no;  //商户订单号
    private String fee_type;  //货币类型，非必填
    private String total_fee; //总金额，接口中提供类型int
    private String spbill_create_ip;  //终端ip
    private String time_start;  //交易起始时间，非必填
    private String time_expire;  //交易结束时间，非必填
    private String goods_tag;  //商品标记，非
    private String notify_url;  //通知地址
    private String trade_type;  //交易类型
    private String product_id;  //商品ID，非
    private String limit_pay;  //支付方式，非
